...
int main()
{
    ...
    srand(time(0));
    int numeriVincenti[DIMV], numeriGiocati[DIMG], numeriVinti[DIMG], i, vinti, soldi, scommessa = 0, puntata = 0;
    bool stop = false;
    ...
    while (!stop)
    {
        ...
        while (puntata == 0)
        {
            ...
            if (!valido)
            {
                cout << "La puntata non e' valida riprova " << endl;
            }

            //? controllo scelta sulla puntata
            bool exit = true;
            while (numero == 0)
            {
                ...
                if (!exit)
                {
                    cout << "La risposta non e' valida riprova " << endl;
                    exit = true;
                }

                cout << "Vuoi puntare su una vincita specifica (si/no) ";
                cin >> scelta;

                if (scelta == "si" || scelta == "Si" || scelta == "SI")
                {
                    cout << "Quanti nmeri vuoi provare ad indovinare (2-5) ";
                    cin >> numero;
                }
        ...
        */
        ...
        case 2:
            if (puntata == 1 || puntata == 2)
            {
                ...
                {
                    cout << "Hai fatto ambo e indovinato la scommessa vincita x2" << endl;
                    soldi += scommessa * (2 * 2);
                }
            }
            else
        ...
        case 3:
            if (puntata == 1 || puntata == 3)
            {
                ...
                {
                    cout << "Hai fatto terno e indovinato la scommessa vincita x2" << endl;
                    soldi += scommessa * (3 * 2);
                }
            }
            else
        ...
        case 4:
            if (puntata == 1 || puntata == 4)
            {
                ...
                {
                    cout << "Hai fatto quaterna e indovinato la scommessa vincita x2" << endl;
                    soldi += scommessa * (5 * 2);
                }
            }
            else
        ...
        case 5:
            if (puntata == 1 || puntata == 4)
            {
                ...
                {
                    cout << "Hai fatto cinquina e indovinato la scommessa vincita x2" << endl;
                    soldi += scommessa * (8 * 2);
                }
            }
            else
        ...
        if (vinti > 1 && (vinti == puntata || vinti == 1))
        {
        ...
        if (soldi == 0)
        {
            ...
            while (soldi == 0)
            {
                ...
                cout << "Vuoi investire altri soldi (si/no) ";
                cin >> risposta;
        ...
        else
        {
            ...
            do
            {
                ...
                cout << "Vuoi scommettere di nuovo (si/no) ";
                cin >> risposta;
